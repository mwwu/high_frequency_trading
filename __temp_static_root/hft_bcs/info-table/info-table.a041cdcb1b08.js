...
class InfoTable extends PolymerElement {
  constructor(){
    ...
    `;
    // infoTable.infoTableShadowDOM.querySelector("table").style.height = document.querySelector(".front_end_controller").clientHeight*0.3;
    console.log(infoTable.infoTableShadowDOM.querySelector("table"));
  }
}
