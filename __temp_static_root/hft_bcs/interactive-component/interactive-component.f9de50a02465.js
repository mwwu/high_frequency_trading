...
class InteractiveComponent extends PolymerElement {
  ...
  `;
  interactiveComponent.interactiveComponentShadowDOM.querySelector(".info-and-buttons").style.width = document.querySelector(".front_end_controller").clientHeight*0.3;
