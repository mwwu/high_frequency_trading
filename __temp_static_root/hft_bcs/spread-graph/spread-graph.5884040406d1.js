...
// <svg id="timer"></svg>
  ...
  */
    ...
    */
    ...
    spreadGraph.checkForTransition = this.checkForTransition;
  ...
  animateBBOShift(desiredCenter, obj){
    ...
    var lock = spreadGraph.checkForTransition();
     spreadGraph.tickLinesText.forEach(text => { 
        ...
        .on("transition_on", function(){
            console.log("Started Text Transition, turn on lock");
        })
        .on("end", function() { console.log("Ended Text Transitions");
            text.remove();
        })
