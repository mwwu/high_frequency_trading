...
// <svg id="timer"></svg>
  ...
  */
  ...
  drawArrows(){
    ...
    if(playersInMarket[otree.playerID]["strategy"] === "maker_basic"){
        spreadGraph.bidArrow["bidArrowLine"].call(d3.drag()
            .on("drag", function(){
                if(spreadGraph.animation){
                    spreadGraph.bidArrow["bidArrowLine"].call(d3.drag().on("drag", null));
                } else{
        ...
        spreadGraph.askArrow["askArrowLine"].call(d3.drag()
            .on("drag", function(){
                if(spreadGraph.animation){
                    spreadGraph.askArrow["askArrowLine"].call(d3.drag().on("drag", null));
                } else {
  ...
  drawBidArrow(obj){
    ...
    console.log(spreadGraph.visibleTickLines[obj["price"]], obj["price"]);
