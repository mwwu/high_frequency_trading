...
// <svg id="timer"></svg>
  ...
  */
  ...
  drawBidArrow(obj){
    ...
    console.log(spreadGraph.visibleTickLines[obj["price"]], spreadGraph.spread_svg.select(".best-bid").attr("cx") );
  ...
  drawOfferArrow(obj){
    ...
    console.log(spreadGraph.visibleTickLines[obj["price"]], spreadGraph.spread_svg.select(".best-offer").attr("cx") );
