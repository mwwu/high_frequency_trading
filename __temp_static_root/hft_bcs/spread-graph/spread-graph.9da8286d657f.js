...
// <svg id="timer"></svg>
  ...
  */
    ...
    */
    ...
    spreadGraph.activeBBOTransitions = [];
  ...
  animateBBOShift(desiredCenter, obj){
    ...
    try{
        ...
        spreadGraph.bidArrow["bidArrowText"].attr("x", spreadGraph.visibleTickLines[spreadGraph.bidArrow["price"]]).transition().duration(300).attr("x",(desiredCenter > spreadGraph.spread_width/2) ? +spreadGraph.bidArrow["bidArrowText"].attr("x") - differenceFromMid : +spreadGraph.bidArrow["bidArrowText"].attr("x")  + differenceFromMid);
        spreadGraph.bidArrow["bidArrowLine"].attr("x1", spreadGraph.visibleTickLines[spreadGraph.bidArrow["price"]]).attr("x2", spreadGraph.visibleTickLines[spreadGraph.bidArrow["price"]]).transition().duration(300).attr("x1",(desiredCenter > spreadGraph.spread_width/2) ? +spreadGraph.bidArrow["bidArrowLine"].attr("x1") - differenceFromMid : +spreadGraph.bidArrow["bidArrowLine"].attr("x1")  + differenceFromMid)
    ...
    spreadGraph.BBOAnimation = false;
  ...
  replaceOrder(oldTOK, newTOK, newPrice){
    ...
    arrowDrag(){
        //Map the drag of the event to arrow in which is recieved  
    }
  ...
  drawArrows(){
    ...
    console.log("Arrows being drawn at " + spreadGraph.bidArrow["price"] + " , " +spreadGraph.askArrow["price"] );
  ...
  executeArrow(obj){
    ...
    if(obj["order_token"][4] == "B"){
        ...
        spreadGraph.spread_svg.select("#bidArrow").transition()
                                            ...
                                            console.log("FINISHED BID ANIMATIONS");
        ...
        spreadGraph.spread_svg.select("#askArrow").transition()
                                            ...
                                            console.log("FINISHED OFFER ANIMATIONS");
    }
  }
  executeOrder(obj){
  ...
  drawBidArrow(obj){
    ...
    console.log(spreadGraph.bidArrow["bidArrowLine"].attr("x1"), spreadGraph.spread_svg.select(".best-bid").attr("cx") );
  ...
  drawOfferArrow(obj){
    ...
    console.log(spreadGraph.askArrow["askArrowLine"].attr("x1"), spreadGraph.spread_svg.select(".best-offer").attr("cx") );
    spreadGraph.confirmArrow(obj);
}
